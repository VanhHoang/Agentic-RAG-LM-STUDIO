productsSample = [
    "Tôi muốn mua iPhone mới nhất",
    "Tôi cần mua Samsung Galaxy A15",
    "Tôi muốn mua điện thoại Samsung",
    "Tôi muốn mua iPhone 15",
    "Tôi có thể mua Xiaomi không?",
    "Tôi muốn tìm mua OPPO",
    "Tôi cần một chiếc điện thoại mới",
    "Tôi muốn mua Galaxy S24",
    "Tôi muốn xem Samsung Galaxy A15",
    "Cho tôi xem iPhone 15 Pro",
    "Tôi quan tâm đến Xiaomi Redmi",
    "Tôi đang tìm OPPO Reno",
    "Mua điện thoại Samsung ở đâu?",
    "Tôi muốn đặt mua iPhone",
    "Có bán Galaxy A52 không?",
    "Tôi cần tư vấn mua điện thoại",
